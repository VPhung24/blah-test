      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <p className={styles.card}>
            CONFIG1 has value:{" "}
            {process.env.NEXT_PUBLIC_CERC_TEST_WEBAPP_CONFIG1 || ""}
          </p>

          <p className={styles.card}>
            CONFIG2 has value:{" "}
            {process.env.NEXT_PUBLIC_CERC_TEST_WEBAPP_CONFIG2 || ""}
          </p>

          <p className={styles.card}>
            WEBAPP_DEBUG has value:{" "}
            {process.env.NEXT_PUBLIC_CERC_WEBAPP_DEBUG || ""}
          </p>
        </div>
      </main>
